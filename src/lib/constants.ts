...
export const PRODUCTS: Product[] = [
  {
    ...
    tagline: 'Your AI business agent — interacting with customers so you don\'t have to.',
    description:
      'AutoOrderSync acts on behalf of your business across WhatsApp, Messenger, and Email. It converses with customers, places orders, reserves tables, handles inquiries, and takes action in your backend — automatically, around the clock.',
    icon: 'MessageSquare',
    gradient: 'from-emerald-500 to-green-600',
    badge: 'AI-Powered',
    badgeColor: 'emerald',
    features: [
      'AI agent that chats with customers on your behalf',
      'Handles orders, table reservations, inquiries & more',
      'Works across WhatsApp, Messenger & Email',
      'Real-time action in your backend — no manual steps',
      'Inventory validation & stock checks',
      'Daily summary reports & analytics',
    ],
    seoTitle: 'AutoOrderSync — AI Business Agent for WhatsApp, Messenger & Email | Canada',
    seoDescription: 'AutoOrderSync by SAMSBPM is an AI agent that acts on behalf of your business — placing orders, reserving tables, and handling customer interactions on WhatsApp, Messenger, and Email automatically. Built for Canadian small businesses.',
    keywords: ['WhatsApp AI agent Canada', 'AI business agent Canada', 'WhatsApp order automation Canada', 'automated customer interaction Canada', 'table reservation bot Canada', 'AI order intake software', 'WhatsApp business automation Canada', 'order automation for small business Canada'],
    longDescription: 'AutoOrderSync is an AI agent that works on behalf of your business — so your team doesn\'t have to be online 24/7 to respond to customers. When a customer messages your business on WhatsApp, Facebook Messenger, or Email, AutoOrderSync handles the conversation: it takes orders, reserves tables, answers product questions, validates inventory, and confirms the action back to the customer — all in real time. Canadian businesses in food, hospitality, retail, and services use AutoOrderSync to serve customers faster, reduce manual work by up to 80%, and never miss an inquiry again.',
    targetAudience: 'Small and medium businesses in Canada that interact with customers through messaging channels — including restaurants, food vendors, grocery stores, produce distributors, retail shops, and hospitality businesses.',
    useCases: ['Restaurants letting customers reserve tables via WhatsApp', 'Food vendors taking and confirming orders through Messenger', 'Grocery stores handling email order lists automatically', 'Retail shops answering product inquiries and placing orders 24/7'],
  },
  {
    id: 'api-vedoryx',
    name: 'Vedoryx-API',
    ...
    badgeColor: 'blue',
    features: [
      'Isolated data per business — fully secure',
    ...
    seoTitle: 'Vedoryx-API — Scalable Backend API Platform for Canadian Businesses',
    seoDescription: 'Vedoryx-API is a scalable backend API platform by SAMSBPM Technologies. Deploy enterprise-grade APIs with rate limiting, versioning, webhooks, and auto-generated documentation. Built for Canadian SaaS companies.',
    keywords: ['scalable API platform Canada', 'backend API development Canada', 'SaaS API infrastructure', 'API management platform Canada', 'scalable API platform small business', 'Canadian API hosting'],
    longDescription: 'Vedoryx-API gives Canadian businesses and developers a production-ready API backbone without the infrastructure overhead. Each business gets completely isolated data and a dedicated environment — no shared state, no risk. Intelligent rate limiting protects your API from abuse, automatic versioning ensures backwards compatibility, and auto-generated documentation keeps developers productive. Webhook support and event streaming make real-time integrations with third-party tools simple.',
    targetAudience: 'Canadian SaaS companies, development agencies, and businesses needing a scalable, secure backend API platform.',
    useCases: ['SaaS startups needing a scalable, isolated API backbone', 'Agencies building client-facing API products', 'Businesses integrating WhatsApp, Stripe, and Shopify workflows', 'Enterprises requiring role-based access and 99.9% uptime'],
  },
  {
  ...
  },
  {
    id: 'billbridge',
    name: 'BillBridge',
    tagline: 'Professional invoicing for consulting firms — automated and stress-free.',
    description:
      'BillBridge is a professional invoice management platform built for consulting businesses. Create, send, and track invoices with Stripe payment tracking, role-based team access, and real-time financial reporting — all at billbridge.ca.',
    icon: 'Receipt',
    gradient: 'from-violet-500 to-purple-600',
    badge: 'Invoicing',
    badgeColor: 'violet',
    features: [
      'Each firm\'s data fully isolated — secure and private',
    ...
    seoDescription: 'BillBridge by SAMSBPM is a professional invoicing platform for Canadian consulting businesses. Create, send, and track invoices with Stripe payments, role-based team access, and real-time financial reporting at billbridge.ca.',
    keywords: ['invoice management software Canada', 'invoicing software for consulting firms Canada', 'billing software for consultants Canada', 'professional invoice software Canada', 'Stripe invoicing Canada', 'invoice tracking software Canada'],
    longDescription: 'BillBridge brings enterprise-grade invoice management to Canadian consulting firms of all sizes. Each consulting firm gets completely isolated data and their own branded invoicing environment. Create professional invoices in seconds, deliver them to clients by email, and track payment status in real time. Stripe integration handles online payments seamlessly, and full billing records give you everything you need for accounting. Role-based access lets principals manage everything while staff handle day-to-day billing. Live at billbridge.ca.',
  ...
  },
  {
    id: 'bookingbuddy',
    name: 'BookingBuddy',
    tagline: 'Universal reservation platform for any service business.',
    description:
      'BookingBuddy is a reservation platform for salons, clinics, restaurants, sports courts, and any service business. Customers book online or via WhatsApp — the AI agent handles scheduling, confirmations, and reminders automatically.',
    icon: 'CalendarCheck',
    gradient: 'from-lime-500 to-emerald-600',
    badge: 'Bookings',
    badgeColor: 'green',
    features: [
      'Universal booking engine for any service industry',
      'WhatsApp AI agent — customers book via chat',
      'Staff & resource scheduling with availability rules',
      'Real-time slot availability & double-booking prevention',
      'Automated confirmations, reminders & notifications',
      'Coupon & discount management',
      'Each business fully isolated — secure and private',
      'Role-based access for admins and staff',
    ],
    seoTitle: 'BookingBuddy — Universal Reservation & Booking Software for Canadian Businesses',
    seoDescription: 'BookingBuddy by SAMSBPM is a reservation platform for salons, clinics, restaurants, and service businesses. Let customers book online or via WhatsApp with AI-powered scheduling, automated confirmations, and staff management.',
    keywords: ['booking software Canada', 'reservation system Canada', 'salon booking software Canada', 'clinic appointment system Canada', 'restaurant reservation software Canada', 'WhatsApp booking Canada', 'online booking system small business Canada', 'appointment scheduling software Canada'],
    longDescription: 'BookingBuddy brings enterprise-grade reservation management to any service business in Canada. Whether you run a salon, clinic, restaurant, sports court, or wellness studio, BookingBuddy gives your customers a seamless way to book — through your website or directly via WhatsApp. The built-in AI agent handles the entire booking conversation: it presents available services and time slots, confirms the appointment, and sends automated reminders. Behind the scenes, smart availability rules respect your business hours, blocked periods, and staff schedules — eliminating double-bookings entirely. Each business gets its own fully isolated, secure environment with role-based access for owners, managers, and staff.',
    targetAudience: 'Canadian service businesses of any size — salons, barbershops, clinics, physiotherapy practices, restaurants, sports facilities, spas, personal trainers, and any business that takes appointments or reservations.',
    useCases: [
      'Salons and barbershops managing staff appointments across multiple services',
      'Clinics letting patients book appointments online or via WhatsApp',
      'Restaurants managing table reservations with automated confirmations',
      'Sports courts and facilities handling hourly slot bookings',
      'Wellness studios scheduling classes, trainers, and treatment rooms',
    ],
  },
  {
    id: 'servstack',
    ...
    features: [
      ...
      'Each vendor fully isolated — secure and independent',
...
export const FAQS = [
  ...
  },
  {
    ...
    answer: 'Yes. AutoOrderSync is an AI agent that acts on behalf of your business on WhatsApp, Messenger, and Email. It converses with customers, places orders, reserves tables, validates inventory, and sends confirmations — all automatically, without your team having to be online.',
  },
  {
    question: 'What is BillBridge and who is it for?',
    answer: 'BillBridge is a professional invoicing platform for Canadian consulting firms and professional services businesses. It lets you create, send, and track invoices with Stripe payment integration, role-based team access, and real-time financial reporting. Available at billbridge.ca.',
  },
  {
