...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    description:
      'BookingBuddy is a multi-tenant reservation SaaS for salons, clinics, restaurants, sports courts, and any service business. Customers book online or via WhatsApp — the AI agent handles scheduling, confirmations, and reminders automatically.',
    icon: 'CalendarCheck',
    ...
    features: [
      ...
      'Multi-tenant — one platform, isolated per business',
    ...
    seoDescription: 'BookingBuddy by SAMSBPM is a multi-tenant reservation SaaS for salons, clinics, restaurants, and service businesses. Let customers book online or via WhatsApp with AI-powered scheduling, automated confirmations, and staff management.',
